...
Built for **Seurat workflows**, `GnRHcell` is optimized for exploratory and reproducible analysis of rare neuroendocrine populations.
...
Main fixes:
- removed obsolete API (`dim_plot`, `score_gnrh_cells`)
- aligned with your actual package functions
- fixed `gnrh_colors("class")` → `gnrh_colors("status")`
- added real `run_gnrh()` workflow
- added diagnostic dashboard
- added marker/network analysis
- polished GitHub presentation style
