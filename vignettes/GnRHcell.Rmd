...
After detection, `stage_gnrh()` separates GnRH lineage identity from the
developmental interpretation. The preferred output is `gnrh_stage`.
...
Secretory support is reported independently in `gnrh_secretory`.
